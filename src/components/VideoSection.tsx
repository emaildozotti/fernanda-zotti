...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  heading: 'Uma conversa antes da conversa.',
  headingEm: 'Assista antes de decidir qualquer coisa.',
  preText: 'Eu sei o que é performar força quando você está fragmentada por dentro. Passei anos assim. O que eu faço hoje nasceu de tudo que aprendi nesse caminho, e do que encontrei do outro lado dele.',
  postText: 'No vídeo acima, Fernanda explica o que é o Método do Espelho e da Restauração, por que ele integra psiquismo e espiritualidade cristã, e o que esperar de uma primeira sessão.',
}
// ════════════════════════════════════════════════════════════════════
