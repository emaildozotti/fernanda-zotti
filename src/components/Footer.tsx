...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  eyebrow: 'o próximo passo é simples',
  heading: 'Você já carregou isso sozinha',
  headingEm: 'tempo suficiente.',
  subtitle: 'A sessão inicial é o espaço para você entender se esse processo faz sentido para o seu momento. Sem pressão. Sem compromisso além de aparecer com honestidade.',
  ctaText: 'Quero agendar minha sessão inicial agora',
}
// ════════════════════════════════════════════════════════════════════
